...
## Project Structure
    ...
    ├── moduleopstest_dev_22931  # Django project configurations
...
1. Clone this repo and `cd moduleopstest_dev_22931`
...
2. Clone this repo and `cd moduleopstest_dev_22931`
